...
echo "${SUB_JOBS}"
echo "${SUB_JOBS}" | parallel -j 23 -u --sshloginfile ${PBS_NODEFILE} --col-sep ' ' '. /mnt/lustre/users/echimusa/AGe_NGS/config.txt;SAM={1} . /mnt/lustre/users/echimusa/AGe_NGS/script/7a.GATK.sh'
